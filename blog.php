            ...
            <hr class="my-4">
              ...
              <div class="row g-5">
                  ...
                  <div class="col-md-5 col-lg-4 order-md-last order-2  bg-light">
                      ...
                      <ul class="list-group mb-3 lihaver">
                          <li class="list-group-item d-flex justify-content-between lh-md">
                            <div class=""><a class="item-link" href="#">Article</a></div>
                              <span class="badge bg-primary rounded-pill">25</span>
                          </li>
                          <li class="list-group-item d-flex justify-content-between lh-md ">
                            <div><a class="item-link" href="#">Article</a></div>
                  ...
                  <div class="col-md-7 col-lg-8 bg-light">
                      ...
                      <hr class="my-4">
                        <div class="row g-3">
                            ...
                            <div class="col-sm-8">
                                <h3 class="card-title">La sécurity</h3>
